...
*/
        ...
        getChildren().addAll(playerLabel, playerEllipse, player1ScoreText, playerOneScoreLabel, player2ScoreText, playerTwoScoreLabel, passButton, restartButton, rulesButton);
